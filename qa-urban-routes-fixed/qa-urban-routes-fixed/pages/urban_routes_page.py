...
class UrbanRoutesPage:
    ...
    add_card_button = (By.XPATH, "//div[@class='pp-row disabled']//div[@class='pp-plus']")  # "Agregar tarjeta"
    ...
    blanket_switch = (By.XPATH, "//div[@class='r-sw-label' and text()='Manta y pañuelos']/../div[@class='r-sw']//span[@class='slider round']")
    blanket_checkbox = (By.XPATH, "//div[@class='r-sw-label' and text()='Manta y pañuelos']/../div[@class='r-sw']//input")
